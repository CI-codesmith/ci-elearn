...
# MICROPROJECT 1.2: Python Libraries for Machine Learning (Beginner)
...
## 🎯 Objective
Get hands-on experience with Python’s core ML libraries: NumPy, Pandas, Matplotlib, and Scikit-learn. Learn basic operations and understand their role in ML workflows.
...
### Task 1: NumPy Basics
- Create arrays, perform simple math operations, and explain why NumPy is useful for ML.

### Task 2: Pandas Basics
- Load a small CSV file (e.g., Iris dataset), create a DataFrame, and perform basic data inspection (head, describe, info).

### Task 3: Matplotlib Basics
- Plot a simple line graph and a scatter plot using sample data. Add axis labels and a title.

### Task 4: Scikit-learn Overview
- Write a short markdown cell explaining what Scikit-learn is used for in ML. (No coding required for beginners.)

---

## 📤 Deliverables
- Jupyter Notebook with code and markdown explanations
- Each group member should contribute at least one code cell and one explanation

---

## 📝 Tips for Beginners
- Use comments to explain your code
- Try running each code cell and see what happens
- Ask for help if you’re stuck—this is your first step into ML coding!
   - Merging and joining
