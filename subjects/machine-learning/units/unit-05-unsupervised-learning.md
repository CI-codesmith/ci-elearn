...
## 📚 Course Materials for Unit V

### 📖 Lecture Slides
**Unit V: Unsupervised Learning Algorithms**

<iframe src="https://gamma.app/embed/bcpup0uso91dkpc" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Unsupervised Learning Algorithms"></iframe>

---

### 🎙️ Podcasts: Clustering, Dimensionality Reduction & Algorithms

**Episode 5: Clustering and Structure Discovery**

<iframe src="https://gamma.app/embed/bcpup0uso91dkpc" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Unsupervised Learning Algorithms"></iframe>

---

**Episode 6: Intuition Before Algorithms**

<iframe src="https://gamma.app/embed/bcpup0uso91dkpc" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Unsupervised Learning Algorithms"></iframe>

---

**Episode 7: Advanced Unsupervised Techniques**

<iframe src="https://gamma.app/embed/bcpup0uso91dkpc" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Unsupervised Learning Algorithms"></iframe>

### 💼 Microprojects for Unit V

Complete the following hands-on projects to reinforce your learning:

1. **[Microproject 5.1: Clustering Basics (K-Means, Hierarchical)](../microprojects/MICROPROJECT_5_1.md)**
   - Learn clustering algorithms
   - Duration: 1.5 weeks | Weight: 10%

2. **[Microproject 5.2: Advanced Clustering Techniques](../microprojects/MICROPROJECT_5_2.md)**
   - Master advanced clustering methods
   - Duration: 1.5 weeks | Weight: 10%

3. **[Microproject 5.3: Dimensionality Reduction & PCA](../microprojects/MICROPROJECT_5_3.md)**
   - Apply dimensionality reduction techniques
   - Duration: 2 weeks | Weight: 12%

---

### 🔬 Practical Sessions for Unit V

Hands-on lab work to apply concepts:

- **[Unit V Practicals & Assignments](../practicals/overview.md)**
