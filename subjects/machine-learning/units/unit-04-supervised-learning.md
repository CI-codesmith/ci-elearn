...
## 📚 Course Materials for Unit IV

### 📖 Lecture Slides
**Unit IV: Supervised Learning Algorithms**

<iframe src="https://gamma.app/embed/jae1r6hdo094den" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Supervised Learning Algorithms"></iframe>

---

### 🎙️ Podcast: Supervised Learning & Rule-Based Systems

**Episode 4: Limits of Rule-Based Systems**

<iframe src="https://gamma.app/embed/8vvlw5ynfmnfa28" style="width: 700px; max-width: 100%; height: 450px" allow="fullscreen" title="Feature Selection and Extraction"></iframe>

### 💼 Microprojects for Unit IV

Complete the following hands-on projects to reinforce your learning:

1. **[Microproject 4.1: Classification Algorithms (Decision Trees, KNN, SVM)](../microprojects/MICROPROJECT_4_1.md)**
   - Implement classification algorithms
   - Duration: 1.5 weeks | Weight: 10%

2. **[Microproject 4.2: Regression Algorithms (Linear, Logistic)](../microprojects/MICROPROJECT_4_2.md)**
   - Master regression techniques
   - Duration: 1.5 weeks | Weight: 10%

3. **[Microproject 4.3: Model Performance Evaluation & Metrics](../microprojects/MICROPROJECT_4_3.md)**
   - Learn model evaluation methods
   - Duration: 2 weeks | Weight: 12%

---

### 🔬 Practical Sessions for Unit IV

Hands-on lab work to apply concepts:

- **[Unit IV Practicals & Assignments](../practicals/overview.md)**
