# MICROPROJECT 2.1: Regression Modeling Challenge
...
## 🎯 Objective
Apply supervised learning algorithms to build and evaluate predictive models. Students will experience the complete ML pipeline: data preparation, model training, evaluation, and comparison.
...
### Dataset Selection
Choose **one** regression dataset:
- **California Housing** (predict house prices)
...
- Use **train/test split** (80/20 or cross-validation)
- Evaluate with **regression metrics:** MSE, RMSE, MAE, R²

### Model Requirements
1. **Data Preprocessing** (encoding, scaling, feature selection)
2. **Model Training** (with hyperparameter tuning)
3. **Model Evaluation** (multiple metrics, residual analysis)
